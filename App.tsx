...
const AppContent: React.FC = () => {
  ...
  const handleLogin = () => {
    ...
    setUser({
      ...
      wins: 6,
      losses: 4,
      level: PlayerLevel.GOLDEN,
      referralCount: 3,
      totalReferralBonus: 45,
      status: 'active'
    });
  };
      ...
      <div className="min-h-screen bg-slate-900 flex items-center justify-center p-4">
        <div className="w-full max-w-md space-y-8 bg-slate-800 p-8 rounded-[2.5rem] border border-slate-700 shadow-2xl relative overflow-hidden">
          <div className="relative z-10">
            <div className="w-16 h-16 bg-amber-500 rounded-2xl flex items-center justify-center font-bebas text-4xl mx-auto mb-6 shadow-xl shadow-amber-500/20">L</div>
            <h1 className="text-3xl font-bebas text-center tracking-widest mb-2">{isLogin ? t.login : t.register}</h1>
            <p className="text-slate-400 text-center text-sm mb-8">Start your Ludo Pro journey today!</p>
            ...
            <div className="space-y-4">
              <div className="space-y-2">
                ...
                <input 
                  ...
                  className="w-full bg-slate-900 border border-slate-700 rounded-xl px-4 py-3 focus:outline-none focus:border-amber-500 transition-colors"
                />
              </div>
              ...
              {phone === '01577378394' ? (
                <div className="space-y-2 animate-in slide-in-from-top-2">
                  ...
                  <input 
                    ...
                    className="w-full bg-slate-900 border border-amber-500 rounded-xl px-4 py-3 focus:outline-none"
                  />
                </div>
              ) : otpSent && (
                <div className="space-y-2 animate-in slide-in-from-top-2">
